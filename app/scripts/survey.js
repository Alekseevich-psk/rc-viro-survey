(function () {
    ...
    const resStore = [
        ...
        "У Вас значительно выраженные симптомы астении (хронической усталости). Незамедлительно обратиться к своему лечащему врачу. Для мониторинга астении (хронической усталости), время от времени проходите данный тест. А также, следите за выпусками «Долго, счастливо, осознано» и Вы узнаете, как победить симптомы астении и вернуть работоспособность!",
    ];
